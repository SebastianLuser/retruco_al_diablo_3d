...
public class TurnManager : MonoBehaviour
{
    ...
    public float opponentPlayDelay = 1.0f;
    public int totalBazas = 3;

    [Header("Game State")]
    public int bazaCount = 0;
    ...
    [Header("Bid State")]
    public bool EnvidoCantado { get; private set; } = false;
    public bool TrucoCantado { get; set; } = false;
    public bool bloqueadoPorCanto = false;

    [Header("Cards Played")]
    public Card lastPlayedCardPlayer = null;
    public Card lastPlayedCardOpponent = null;

    [Header("Envido System")]
    private EnvidoManager currentEnvidoManager;
    ...
    public void TransitionToEnvidoState(EnvidoManager envidoManager)
    {
        ...
        fsm.ChangeState(new EnvidoState(this, envidoManager));
    }
    ...
    public void TransitionToPlayState()
    {
        ...
        fsm.ChangeState(new PlayState(this, activePlayer, true));
    }
    ...
    public void TransitionToGameOver()
    {
        ...
        fsm.ChangeState(new GameOverState(this));
    }
