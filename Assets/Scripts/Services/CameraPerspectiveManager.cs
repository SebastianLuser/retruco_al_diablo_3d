...
namespace Services
{
    ...
    public class CameraPerspectiveManager : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            {
                transform.position = Vector3.Lerp(transform.position, targetPerspective.position,
                    Time.deltaTime * transitionSpeed);
                transform.rotation = Quaternion.Slerp(transform.rotation, targetPerspective.rotation,
                    Time.deltaTime * transitionSpeed);
            }
        }
