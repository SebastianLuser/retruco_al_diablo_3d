...
namespace UI
{
    public class HandAestheticMover : MonoBehaviour
    {
        ...
        [Header("Rango Horizontal")] [Tooltip("Posición X mínima (en espacio local) de la mano.")] [SerializeField]
        private float minX = -0.5f;

        [Tooltip("Posición X máxima (en espacio local) de la mano.")] [SerializeField]
        private float maxX = 0.5f;

        [Header("Altura y Profundidad")] [Tooltip("Altura base Y de la mano en espacio local.")] [SerializeField]
        private float fixedY = 0.1f;

        [Tooltip("Profundidad Z de la mano en espacio local.")] [SerializeField]
        private float fixedZ = 0.5f;
        ...
        [Header("Bobbing Vertical")] [Tooltip("Amplitud del bobbing sobre Y.")] [SerializeField]
        private float bobAmplitude = 0.02f;

        [Tooltip("Frecuencia del bobbing (veces por segundo).")] [SerializeField]
        ...
        [SerializeField]
        private float mouseYOffsetAmplitude = -0.001f;
