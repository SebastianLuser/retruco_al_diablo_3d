...
namespace UI
{
    ...
    {
        [Header("Prefab del tooltip")] [Tooltip("Prefab del Panel que contiene un Text o TMP_Text")]
        public GameObject tooltipPrefab;

        [Header("Padre UI")] [Tooltip("Transform del Canvas (Screen Space) donde instanciar el panel")]
        public Transform uiParent;

        [Header("Contenido")] [Tooltip("Texto que saldrá en el tooltip")] [TextArea]
